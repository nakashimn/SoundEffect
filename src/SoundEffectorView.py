...
class SoundEffectorView(QtGui.QWidget):
    def __init__(self, model, parent = None):
        ...
        self.switchBox.addWidget(self.distortion_switch,1,0)
        self.switchBox.addWidget(self.phaser_switch,2,0)
        self.switchBox.addWidget(self.post_booster_switch,3,0)
        """ Graph Widget """
